        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="container">
    <div class="row">
        <!-- Icono para visualizar un reporte -->
        <div class="col-xl-3 col-md-6">
            <a href="interfaz_admin1.php" class="icon-card bg-primary">
                <div class="icon"><i class="fas fa-chart-line"></i></div>
                <div class="description">Visualizar Reporte</div>
            </a>
        </div>
        <!-- Icono para generar un reporte -->
        <div class="col-xl-3 col-md-6">
            <a href="interfaz_admin2.php" class="icon-card bg-secondary">
                <div class="icon"><i class="fas fa-chart-bar"></i></div>
                <div class="description">Generar Reporte</div>
            </a>
        </div>
    </div>
</div>
